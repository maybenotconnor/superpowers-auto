...
- All other forbidden-response and pushback rules still apply — no performative agreement, push back with technical reasoning when correct to do so. You just route those pushbacks to the orchestrator via your trailer's `SUMMARY`, not to a human inline.
